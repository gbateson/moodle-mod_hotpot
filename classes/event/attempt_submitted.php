...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_attempt_submitted', 'mod_hotpot');
    }
    ...
    public function get_description() {
        return get_string('event_attempt_submitted_desc', 'mod_hotpot', $this);
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'hotpot', 'OLD_attempt_submitted', 'view.php?id='.$this->objectid, $this->other['hotpotid'], $this->contextinstanceid);
    }
